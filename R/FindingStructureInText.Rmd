...
text_data$Category_TDA[text_data$Betti_Num >= 2 & text_data$Betti_Num <= 4] = 'entertainment / sport'
text_data$Category_TDA[text_data$Betti_Num == 3] = 'business'
text_data$Category_TDA[text_data$Betti_Num >= 3 & text_data$Betti_Num <= 4] = 'business / sport'
text_data$Category_TDA[text_data$Betti_Num > 3 & text_data$Betti_Num < 5] = 'sport'
text_data$Category_TDA[text_data$Betti_Num == 5] = 'sport / tech'
text_data$Category_TDA[text_data$Betti_Num > 5 & text_data$Betti_Num < 8] = 'tech'
text_data$Category_TDA[text_data$Betti_Num == 8] = 'tech / politics'
text_data$Category_TDA[text_data$Betti_Num > 8] = 'politics'
