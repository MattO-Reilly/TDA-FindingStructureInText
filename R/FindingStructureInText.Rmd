...
tech_dtm <- removeSparseTerms(tech_dtm, 0.71)
tech_barcode <- ripsDiag(as.matrix(tech_dtm), 1, 20, printProgress = FALSE)
...
business_dtm <- removeSparseTerms(business_dtm, 0.71)
business_barcode <- ripsDiag(as.matrix(business_dtm), 1, 30, printProgress = FALSE)
...
sport_dtm <- removeSparseTerms(sport_dtm, 0.71)
sport_barcode <- ripsDiag(as.matrix(sport_dtm), 1, 20, printProgress = FALSE)
...
entertainment_dtm <- removeSparseTerms(entertainment_dtm, 0.71)
entertainment_barcode <- ripsDiag(as.matrix(entertainment_dtm), 1, 20, printProgress = FALSE)
...
politics_dtm <- removeSparseTerms(politics_dtm, 0.71)
politics_barcode <- ripsDiag(as.matrix(politics_dtm), 1, 20, printProgress = FALSE)
...
text_data$Category_TDA[text_data$Betti_Num == 3] = 'business'
text_data$Category_TDA[text_data$Betti_Num == 6] = 'sport / tech'
#text_data$Category_TDA[text_data$Betti_Num == 6] = 'tech'
text_data$Category_TDA[text_data$Betti_Num == 5] = 'politics'
...
text_data$correct[is.na(text_data$correct)]<- 0
